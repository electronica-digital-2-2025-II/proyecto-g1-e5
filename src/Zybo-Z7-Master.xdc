...
##Pmod Header JC                                                                                                                  
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33     } [get_ports { GPIO_0_tri_i[0] }]; #inductivo 			 
set_property -dict { PACKAGE_PIN W15   IOSTANDARD LVCMOS33     } [get_ports { GPIO_0_tri_i[1] }]; #humedad	     
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33     } [get_ports { GPIO_0_tri_i[2] }]; #color            
...
#set_property -dict { PACKAGE_PIN T12   IOSTANDARD LVCMOS33     } [get_ports { IIC_0_sda_io }]; #
set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33     } [get_ports { GPIO_0_tri_i[3] }]; #infrarojo           
                                                                                                                                 
                                                                                                                                 
##Pmod Header JD                                                                                                                  
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33     } [get_ports { GPIO2_0_tri_o[0] }]; #Motor                
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33     } [get_ports { GPIO2_0_tri_o[1] }]; #Motor			 
set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33     } [get_ports { GPIO2_0_tri_o[2] }]; #Motor             
set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33     } [get_ports { GPIO2_0_tri_o[3] }]; #Motor          
set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33     } [get_ports { GPIO2_0_tri_o[4] }]; #Servo         
#set_property -dict { PACKAGE_PIN U15   IOSTANDARD LVCMOS33     } [get_ports { GPIO2_0_tri_o[5] }]; #IO_L11N_T1_SRCC_34 Sch=jd_n[3]            
#set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33     } [get_ports { GPIO_0_tri_i[0] }]; #IO_L21P_T3_DQS_34 Sch=jd_p[4]             
#set_property -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33     } [get_ports { jd[7] }]; #IO_L21N_T3_DQS_34 Sch=jd_n[4]             
                                                                                                                                 
                                                                                                                                 
##Pmod Header JE                                                                                                                  
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { GPIO2_0_tri_o[5] }]; #IO_L4P_T0_34 Sch=je[1]						 
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { GPIO2_0_tri_o[6] }]; #color S2                    
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { GPIO2_0_tri_o[7] }]; #color S3                          
set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { GPIO2_0_tri_o[8] }]; #IO_L19P_T3_35 Sch=je[4]                     
set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS33 } [get_ports { LCD_scl_io }]; #SCL LCD         
set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { LCD_sda_io }]; #SDA LC                 
